...
public class TarjetaController {
	...
	public ResponseEntity getOne(@PathVariable long id){
		...
		try {
			return ResponseEntity.status(HttpStatus.OK).body(tarjetaService.findById(id));
		} catch (Exception e) {
			return ResponseEntity.status(HttpStatus.NOT_FOUND).body("{\"message\": \"Error. Please try again later.\"}");
		}
	...
	@PostMapping("/")
	@Transactional
	public ResponseEntity post(@RequestBody TarjetaDTO dto){
		
		try {
			return ResponseEntity.status(HttpStatus.OK).body(tarjetaService.save(dto));
		} catch (Exception e) {
			return ResponseEntity.status(HttpStatus.NOT_FOUND).body("{\"message\": \"Error. Please try again later.\"}");
	...
	@PutMapping("/{id}")
	@Transactional
	public ResponseEntity put(@PathVariable long id, @RequestBody TarjetaDTO dto){
		
		try {
			return ResponseEntity.status(HttpStatus.OK).body(tarjetaService.update(id, dto));
		} catch (Exception e) {
			return ResponseEntity.status(HttpStatus.NOT_FOUND).body("{\"message\": \"Error. Please try again later.\"}");
		}
